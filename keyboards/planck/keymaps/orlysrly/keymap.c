...
[_NUMPAD] = LAYOUT_planck_grid(
    LOCK,    SGUI(KC_4), SGUI(KC_5), _______, _______, _______, _______, KC_7, KC_8,   KC_9,    KC_PLUS, KC_MINS,
    _______, _______,    _______,    _______, _______, _______, _______, KC_4, KC_5,   KC_6,    KC_ASTR, KC_SLSH,
