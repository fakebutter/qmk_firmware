...
qk_tap_dance_action_t tap_dance_actions[] = {
  //[TD_PLUS] = ACTION_TAP_DANCE_DOUBLE(KC_PLUS, KC_MINS),
  //[TD_MULT] = ACTION_TAP_DANCE_DOUBLE(KC_ASTR, KC_SLSH)
};
...
#define FN     TG(_FN)
#define LOCK   LGUI(LALT(KC_POWER))
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Num  |  Fn  | Alt  | GUI  |Lower |    Space    |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    KC_TAB,   KC_Q, KC_W,    KC_E,    KC_R,  KC_T,   KC_Y,   KC_U,  KC_I,    KC_O,    KC_P,    KC_BSPC,
    CTRL_ESC, KC_A, KC_S,    KC_D,    KC_F,  KC_G,   KC_H,   KC_J,  KC_K,    KC_L,    KC_SCLN, KC_QUOT,
    SHFT_GRV, KC_Z, KC_X,    KC_C,    KC_V,  KC_B,   KC_N,   KC_M,  KC_COMM, KC_DOT,  KC_SLSH, KC_ENT ,
    NUMPAD,   FN,   KC_LALT, KC_LGUI, LOWER, KC_SPC, KC_SPC, RAISE, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_COLEMAK] = LAYOUT_planck_grid(
    ...
    SHFT_GRV, KC_Z, KC_X,    KC_C,    KC_V,  KC_B,   KC_K,   KC_M,  KC_COMM, KC_DOT,  KC_SLSH, KC_ENT ,
    NUMPAD,   FN,   KC_LALT, KC_LGUI, LOWER, KC_SPC, KC_SPC, RAISE, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),

/* Numpad
 * ,-----------------------------------------------------------------------------------.
 * | Lock |ScrCap|ScrCap|      |      |      |      |   7  |   9  |   0  |   /  |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |   4  |   5  |   6  |   *  |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |   1  |   2  |   3  |   -  |      |
...
[_NUMPAD] = LAYOUT_planck_grid(
    LOCK,    SGUI(KC_4), SGUI(KC_5), _______, _______, _______, _______, KC_7, KC_8,   KC_9,    KC_SLSH, _______,
    ...
    _______, _______,    _______,    _______, _______, _______, _______, KC_0, KC_DOT, _______, KC_PLUS, _______
),
...
[_FN] = LAYOUT_planck_grid(
    ...
    _______, G(KC_A), _______, _______, _______, _______, KC_HOME, KC_LEFT, KC_DOWN, KC_RIGHT, KC_END,  _______,
...
[_ADJUST] = LAYOUT_planck_grid(
  ...
  float fn_on_song[][2]  = SONG(E__NOTE(_B4));
  float fn_off_song[][2] = SONG(E__NOTE(_B2));
#endif

bool was_fn_layer = false;
  ...
  switch (get_highest_layer(state)) {
    case _FN:
      if (!was_fn_layer) {
        was_fn_layer = true;
#ifdef AUDIO_ENABLE
        PLAY_SONG(fn_on_song);
#endif
      }
      break;
    default:
      if (was_fn_layer && get_highest_layer(state) < _FN) {
        was_fn_layer = false;
#ifdef AUDIO_ENABLE
